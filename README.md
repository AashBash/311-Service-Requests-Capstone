...
Welcome to my capstone project "NYC 311 Service Requests Analysis & Predictive Modeling". This project analyzes NYC 311 service request data to uncover trends in complaint types, agency performance, and geographic disparities and builds a predictive model to identify complaints likely to face delays.
